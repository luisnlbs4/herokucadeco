...
class SalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post salas_url, params: { sala: { apikey: @sala.apikey, minutos: @sala.minutos, nombre: @sala.nombre, sessionID: @sala.sessionID, token: @sala.token } }
    end
  ...
  test "should update sala" do
    patch sala_url(@sala), params: { sala: { apikey: @sala.apikey, minutos: @sala.minutos, nombre: @sala.nombre, sessionID: @sala.sessionID, token: @sala.token } }
